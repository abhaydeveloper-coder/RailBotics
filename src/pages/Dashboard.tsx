...
export const Dashboard: React.FC = () => {
  ...
  const [conflictsCount] = useState(4);
  ...
  const stats = {
    ...
    avgDelay: Math.round(trains.reduce((sum, train) => sum + train.delay, 0) / trains.length),
    throughput: 24,
            ...
            <Card className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">{stats.throughput}/hr</p>
                </div>
              </div>
            </Card>
          </motion.div>
                  ...
                  <>
                    <div className="bg-yellow-50 p-4 rounded-lg">
                      ...
                      <p className="text-sm text-yellow-700">
                        These conflicts are affecting schedule efficiency. Resolve them to improve operations.
                      </p>
                    </div>
                    
                    <button 
                      onClick={() => navigateToPage('conflicts')}
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button className="bg-gray-100 py-3 rounded-lg hover:bg-gray-200 transition-colors">
                    <div className="text-blue-600 mb-1">
                      <Train className="w-6 h-6 mx-auto" />
                    </div>
                ...
                <button 
                  onClick={() => navigateToPage('simulation')}
